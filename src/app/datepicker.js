    ...
    constructor(host, s) {
        ...
        t.load = function (n) {
            ...
            if (n == "day") {
                ...
                head.colSpan = 5;
                head.innerHTML =
                    months[t.date.getMonth()] + " " + t.date.getFullYear();
                head.onclick = () => {
                    t.load("month");
                };
                ...
                for (let y = 0; y < 3; y++) {
                    ...
                    for (let x = 0; x < 4; x++) {
                        ...
                        if (
                            (t.firstdate != undefined
                                ? day.getTime() >=
                                  new Date(t.firstdate).setDate(1)
                                : true) &&
                            (t.lastdate != undefined
                                ? day.getTime() <=
                                  new Date(t.lastdate).setDate(1)
                                : true)
                        ) {
